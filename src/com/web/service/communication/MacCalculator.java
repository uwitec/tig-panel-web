 ...
 * 
 */
public class MacCalculator extends BaseForm implements Serializable{
	/**
	 * 
	 */
	...
	// 3DesMac
	private byte[] MAC16(int[][] iSubKeys1, int[][] iSubKeys2,
			byte[] bInit, byte[] bCiphertext) {
	 ...
	 *  strInitData:初始因子.长度必须为16,一般为:0000000000000000
	 *  strMacData:MAC数据,长度必须为偶数
	 */
	private String Str3MAC(String strKey, String strInitData,
			String strMacData) {
		String strKey1;
		String strKey2;
		if ((strKey.length()) != 32) {
		...
		byte[] bInit = hex2byte(strInitData.getBytes()); //初始因子
		byte[] bCiphertext = hex2byte(strMacData.getBytes()); //MAC数据
		...
		System.out.println("strKey:"+strKey+" strInitData:"+strInitData+" strMacData:"+strMacData);
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//String communicationKey = macCal.StrDe3DES(bimacposinfotb.getPosidpk(), ret_dg2051.getKeyset());
		String communicationKey = macCal.StrDe3DES("241F6C9BF12B03A7D87941A040931041","3FE7EB76AFD447219F4DC2CB2E145595");
	    System.out.println(communicationKey);
	    
	    String communicationKey11 = macCal.StrDe3DES("11111111111111111111111111111111","31313131313131313132313531313131");
	    System.out.println(communicationKey11);
	}
}

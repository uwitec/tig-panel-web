...
public class tdsvsusdtltb extends BaseForm implements Serializable{
	...
	private Integer sussalemode      ;
	private Integer sustradebegindate;
	private Integer sustradeenddate  ;
	private String sustacbuf        ;
	private String susauthseq       ;
	private Integer suslimitedauthseq;
	...
	private String sussalemodedesc;
	
	
	
	public String getSussalemodedesc() {
		return sussalemodedesc;
	}
	public void setSussalemodedesc(String sussalemodedesc) {
		this.sussalemodedesc = sussalemodedesc;
	}
	...
	public Integer getSussalemode() {
		return sussalemode;
	}
	public void setSussalemode(Integer sussalemode) {
		this.sussalemode = sussalemode;
	}
	public Integer getSustradebegindate() {
		return sustradebegindate;
	}
	public void setSustradebegindate(Integer sustradebegindate) {
		this.sustradebegindate = sustradebegindate;
	}
	public Integer getSustradeenddate() {
		return sustradeenddate;
	}
	public void setSustradeenddate(Integer sustradeenddate) {
		this.sustradeenddate = sustradeenddate;
	}
	...
	public String getSusauthseq() {
		return susauthseq;
	}
	public void setSusauthseq(String susauthseq) {
		this.susauthseq = susauthseq;
	}
	public Integer getSuslimitedauthseq() {
		return suslimitedauthseq;
	}
	public void setSuslimitedauthseq(Integer suslimitedauthseq) {
		this.suslimitedauthseq = suslimitedauthseq;
	}
	...
	public Integer getSusadjdpt() {
		return susadjdpt;
	}
	public void setSusadjdpt(Integer susadjdpt) {
		this.susadjdpt = susadjdpt;
	}
	...
	public Integer getSusreloadcnt() {
		return susreloadcnt;
	}
	public void setSusreloadcnt(Integer susreloadcnt) {
		this.susreloadcnt = susreloadcnt;
	}
}